...
def detect_face():
    ...
    face_csc = cv2.CascadeClassifier(r"C:\Users\Codemaster\Desktop\Python project\Completed\Detector\Face\haarcascade_frontalface_default.xml")
...
Button(detector,text='Detect face',command=detect_face).place(x=870,y=300)
